	...
	_createClass(User, [{
		...
		value: function render() {
			return React.createElement(
				'div',
				{ style: { textAlign: 'center', padding: '5px', borderColor: '#7FFF00', borderWidth: '1px', borderStyle: 'solid', margin: '2px 0px 2px 0px', borderRadius: '10px', width: '250px', height: '150px' } },
				React.createElement(
					'a',
					{ href: this.props.user.html_url, target: '_blank', style: { textDecoration: 'none', color: 'black', marginTop: '15px', textAlign: 'center' } },
					React.createElement('img', { src: this.props.user.avatar_url, style: { maxWidth: '100px' } }),
					React.createElement(
						'p',
						{ style: { margin: '0px', padding: '2px 0px 2px 0px' } },
